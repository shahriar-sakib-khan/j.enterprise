      ...
      <div className="bg-blue-50 border-b border-blue-200 py-4">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="flex items-center text-sm text-blue-400">
            ...
            <ChevronRight className="w-4 h-4 mx-2" />
            <span className="text-[#0A192F] font-medium">{service.title}</span>
          </div>
        </div>
      </div>
            ...
            <div className="lg:col-span-8 prose prose-lg max-w-none text-blue-700">
              ...
              <div className="bg-blue-50 p-8 border border-blue-100 my-10">
                ...
                <Link 
                  ...
                  className="inline-flex items-center justify-center bg-[#0A192F] text-white px-6 py-3 font-medium hover:bg-[#112240] transition-colors no-underline"
                >
                  Send an Enquiry
                </Link>
              </div>
